...
| --- | --- | --- | --- |
| P-001–P-011 protocol | Implemented and committed | Isolated Robinhood EVM suite; canonical types; versioned factory and registries; exact USDG custody; membership eligibility and signed revocation; human decision and appeal authority; conservative accounting; settlement; agent policy; incident controls; generated ABI and manifest | Independent audit, live USDG/config readback, deployed addresses, source and bytecode verification, role transfer, signer rehearsal |
...
8. **Release provenance.** Generated artifacts bind the source revision and raw
